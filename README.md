...
> 현재 상태: **단계 8 + 배치 저장 완료 (v0.4.0, MVP 핵심)** — 다중 불러오기·썸네일·다중선택, 미리보기, 2구역 폼, 롤 공통 적용, 선택분 날짜·시간 자동증가·느슨한 입력, original/ 폴더 백업, 모든 사진 저장(부분실패 격리·진행률), 필름·현상소 UserComment 저장/복원.
